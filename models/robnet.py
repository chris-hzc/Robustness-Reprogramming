...
from .conv2d import RobustConv2d, CustomConv2d
...
class RobustBasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        super(RobustBasicBlock, self).__init__()
        self.conv1 = RobustConv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = RobustConv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)
